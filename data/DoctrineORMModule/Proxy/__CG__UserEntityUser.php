...
class User extends \User\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'email', 'fullName', 'password', 'language', 'status', 'dateCreated', 'passwordResetToken', 'passwordResetTokenCreationDate', 'wastes', 'posts', 'comments'];
        }
    ...
    public function getWastes()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getWastes', []);

        return parent::getWastes();
    }

    /**
     * {@inheritDoc}
     */
    public function addWaste(\User\Entity\Waste $waste)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addWaste', [$waste]);

        return parent::addWaste($waste);
    }
